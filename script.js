...
function calcularTransformacao() {
  ...
  let gorduraBase = 0;
  if (calcState.objetivo === 'definicao') gorduraBase = 9.0;
  else if (calcState.objetivo === 'massa') gorduraBase = 3.5;
  else gorduraBase = 6.0; // "Os dois"
  ...
  if (gorduraPerda > 15) gorduraPerda = 15;
  gorduraPerda = gorduraPerda.toFixed(1);

  // STEP 7 - Ganho de massa muscular (kg)
  let massaBase = 0;
  if (calcState.nivel === 'iniciante') massaBase = 3.8;
  else if (calcState.nivel === 'intermediario') massaBase = 2.5;
  else massaBase = 1.2;
...
function calcModal() {
  ...
  if (idade && peso && altura && idade >= 15 && peso >= 40) {
    ...
    let gorduraBase = 0;
    if (modalState.mobjetivo === 'definicao') gorduraBase = 9.0;
    else if (modalState.mobjetivo === 'massa') gorduraBase = 3.5;
    else gorduraBase = 6.0;
    ...
    let massaBase = 0;
    if (modalState.mnivel === 'iniciante') massaBase = 3.8;
    else if (modalState.mnivel === 'intermediario') massaBase = 2.5;
    else massaBase = 1.2;
